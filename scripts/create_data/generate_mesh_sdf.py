...
meshes_folder = os.path.join(data_folder, 'objects')
...
if __name__ == '__main__':
    ...
    grasp_cls_folder = os.path.join(grasps_folder)
    count = 0
    for filename in os.listdir(grasp_cls_folder):
        try:
            ...
            mesh_load_file = os.path.join(meshes_folder, mesh_fname)
            ...
            ## save info
            save_sdf_folder = os.path.join(sdf_folder)
